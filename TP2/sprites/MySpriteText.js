...
class MySpriteText {
	 ...
	 */
	initSpriteSheet() {
		// if there's no font sprite sheet created yet, creates it
		if (!this.scene.graph.database.fontSpriteSheet) {
			const ascii = new CGFtexture(this.scene, MySpriteText.textTexturePath)
			this.scene.graph.database.fontSpriteSheet = new MySpriteSheet(
				this.scene,
				ascii,
				MySpriteText.sizeM,
				MySpriteText.sizeN
		...
		this.spriteSheet = this.scene.graph.database.fontSpriteSheet
	}
